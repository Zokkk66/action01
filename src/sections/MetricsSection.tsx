...
export default function MetricsSection() {
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pt-32 pb-32">
        <motion.p
        ...
        <div className="grid gap-16 md:grid-cols-3 md:gap-8">
          {metrics.map((m, i) => (
            ...
            >
              <p className="text-[clamp(48px,10vw,96px)] font-light leading-none tracking-[-0.04em] text-white">
                {m.value}
              </p>
              <p className="mt-4 text-[13px] tracking-wide text-white/40 sm:text-[15px]">
                {m.label}
              </p>
            </motion.div>
          ))}
